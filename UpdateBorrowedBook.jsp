<%-- 
    Document   : UpdateBorrowedBook
    Created on : 10-May-2019, 16:13:37
    Author     : Chathurika
--%>
    ...
    <div id="about" class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                ...
                <form method="post" name="insertForm"  action="UpdateBBProcess.jsp">

                    <div class="form-group">
                        <label for="formGroupExampleInput2">ID of the Student</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" name="sID" value="<%=resultSet.getString("sID")%>">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput4">ISBM No</label>
                        <input type="text" class="form-control" id="formGroupExampleInput4" name="ISBM_no" value="<%=resultSet.getString("ISBM_no")%>" >
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput4">Issue Date</label>
                        <input type="date" class="form-control" id="formGroupExampleInput4" name="issueDate" value="<%=resultSet.getString("issueDate")%>">
                    </div>
                    <div class="form-group" >
                        <label for="formGroupExampleInput4">Return Date</label>
                        <input type="date" class="form-control" id="formGroupExampleInput4" name="returnDate" value="<%=resultSet.getString("returnDate")%>">
                    </div>
                    <br>
