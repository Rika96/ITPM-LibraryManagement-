...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="imgs/book1.jpg" alt="HP1" width="400" height="300">
        <p><strong>Harry Potter</strong></p>
        <p>The Philosepher's Stone</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="imgs/book2.jpeg" alt="HP2" width="400" height="300">
        <p><strong>Harry Potter</strong></p>
        <p>Deathly Hallows</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="imgs/book3.jpg" alt="HP3" width="400" height="300">
        <p><strong>Harry Potter</strong></p>
...
<footer class="container-fluid text-center">
  ...
  <p>ADM Library made by <a href="https://www.google.com" title="Visit w3schools">www.w3schools.com</a></p>
</footer>
