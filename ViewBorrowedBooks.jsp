...
%>
 ...
 <center>     
<table class="tablestyle" style="width: 80%" border="1">
...
<td><%=resultSet.getString("ISBM_no") %></td>
<td><%=resultSet.getString("issueDate") %></td>
<td><%=resultSet.getString("returnDate") %></td>
<td><a href="UpdateBorrowedBook.jsp?sID=<%=resultSet.getString("sID")%>" onclick="return confirm('Are you sure to edit?')">Edit</a></td>
<td><a href="DeleteBorrowedBook.jsp?sID=<%=resultSet.getString("sID")%>" onclick="return confirm('Are you sure to delete?')">Delete</a></td>
...
<a href="Book_Borrow.jsp"><button class="button" style="vertical-align:middle"><span>Add a new record</span></button></a><br><br>
